...
const formats: DateFormat[] = [
  {
    name: t('tools.date-converter.formats.jsLocaleDateString'),
  ...
  {
    name: t('tools.date-converter.formats.utcFormat'),
  ...
  {
    name: t('tools.date-converter.formats.excelDateTime'),
...
const validation = useValidation({
  ...
  rules: [
    {
      message: t('tools.date-converter.validation.invalidDate'),
      validator: value =>
        withDefaultOnError(() => {
          if (value === '') {
            return true;
  ...
  <div>
    <div flex gap-2>
      <c-input-text
        ...
        autofocus
        :placeholder="t('tools.date-converter.placeholder.putDateHere')"
        clearable
    ...
    <input-copyable
      ...
      :placeholder="t('tools.date-converter.placeholder.invalidDate')"
      :test-id="name"
      readonly
      mt-2
    />
