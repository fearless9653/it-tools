...
const jsonValidationRules = [
  {
    ...
    message: t('tools.json-diff.message.invalidJsonFormat'),
  },
];
</script>
...
<template>
  <c-input-text
    ...
    :label="t('tools.json-diff.label.firstJson')"
    :placeholder="t('tools.json-diff.placeholder.firstJson')"
    rows="20"
    multiline
    test-id="leftJson"
    raw-text
  ...
  <c-input-text
    ...
    :validation-rules="jsonValidationRules"
    :label="t('tools.json-diff.label.jsonToCompare')"
    :placeholder="t('tools.json-diff.placeholder.jsonToCompare')"
    rows="20"
    multiline
    test-id="rightJson"
    raw-text
